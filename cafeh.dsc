...
DSC:
  ...
  run:
    ...
    block_sim_two_pipeline: small_genotype * genotype2ld * block_study_sim_2 * individual2summary * (fit_cafeh_genotype_suggested * score_coloc_cafeh, coloc, caviar, fit_susie_genotype_suggested)
