...
DSC:
  ...
  run:
    ...
    ldscore_pipeline: large_genotype * genotype2ld * ldscore_sim * individual2summary * (fit_cafeh_genotype_suggested * score_coloc_cafeh, coloc)
    ld_pipeline_small: small_genotype * genotype2ld * (ld_sim_coloc, ld_sim_no_coloc) * individual2summary * (fit_cafeh_genotype_suggested * score_coloc_cafeh, coloc, caviar)
    ld_pipeline_med: medium_genotype * genotype2ld * ld_sim * individual2summary * (fit_cafeh_genotype_suggested * score_coloc_cafeh, coloc, caviar)
