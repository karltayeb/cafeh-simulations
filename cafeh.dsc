...
DSC:
  ...
  run:
    ...
    block_sim_pipeline: small_genotype * genotype2ld * r2_between_blocks * individual2summary * (fit_cafeh_genotype_suggested * score_coloc_cafeh, coloc, caviar, fit_susie_genotype_suggested)
